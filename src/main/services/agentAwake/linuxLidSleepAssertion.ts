// Holds a `systemd-inhibit` lock (sleep + handle-lid-switch) while agents are
// working so logind doesn't suspend the machine - including on lid close, which
// ordinary sleep inhibitors don't cover on many systems.
