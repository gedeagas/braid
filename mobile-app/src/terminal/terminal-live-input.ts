...
/**
 * Map a React Native key-press event key to the raw bytes a terminal expects.
 * Live-input passthrough sends printable characters via `onChangeText`, but
 * keys that produce no character (Backspace) must be translated here.
 */
